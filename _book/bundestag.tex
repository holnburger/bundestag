...
\caption{\label{tab:unnamed-chunk-24}Bundestagsabgeordnete aller Wahlperioden nach Geschlecht}
\centering
\begin{tabular}[t]{lrr}
\toprule
geschlecht & n & freq\\
...
{\centering \includegraphics{bundestag_files/figure-latex/unnamed-chunk-25-1} 
